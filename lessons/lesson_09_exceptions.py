...
print("El programa continúa su ejecución de forma controlada.")""",
    "steps": [
        ...
        {
            "highlight": {"line": 12},
            "what": "Dentro del 'except', se informa del error y se describe la acción correctiva.",
            "why": "Un buen manejo de errores no solo evita que el programa se rompa, sino que también proporciona información útil sobre qué falló y por qué. Esto es crucial para la depuración y la auditoría.",
            "appData": "Un buen logging de errores es fundamental. Permite a los desarrolladores y analistas entender por qué falló un proceso nocturno y cómo solucionarlo.",
            "appLaw": "La acción correctiva es la clave. No basta con registrar el fallo; hay que definir el siguiente paso procesal. Este bloque de código documenta y ejecuta ese paso, asegurando que el proceso general no se detenga de forma incontrolada."
        },
        {
            "highlight": {"line": 15},
