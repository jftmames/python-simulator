    ...
    "steps": [
        {
            ...
            "state": {"globals": {"calcular_interes_simple": "<function>"}}
        },
        {
            "highlight": {"line": 12},
            "what": "La instrucción 'assert' comprueba si el resultado de la función es exactamente 50.0. Como lo es, la prueba pasa.",
            ...
            "state": {"io": {"log": ["Ejecutando test_calculo_normal()... OK"]}}
        },
        {
            "highlight": {"line": 15},
            ...
            "state": {"io": {"log": ["Ejecutando test_calculo_normal()... OK", "Ejecutando test_valores_negativos()... OK"]}}
        }
    ]
}
