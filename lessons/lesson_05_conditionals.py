...
if pago_recibido == True:
    ...
    "steps": [
        {
            "highlight": {"line": 2},
            "what": "Se define una variable booleana que representa un hecho: si se ha recibido o no un pago.",
        ...
        {
            "highlight": {"line": 5},
            "what": "La instrucción 'if' evalúa si la condición 'pago_recibido == True' es verdadera.",
        ...
        {
            "highlight": {"line": 7},
            "what": "Como la condición del 'if' fue falsa, el programa salta al bloque 'else'.",
        ...
        {
            "highlight": {"line": 10},
            "what": "Dentro del 'else', se anida otro 'if' para comprobar una condición secundaria.",
