...
print(acta)""",
    "steps": [
        {
            "highlight": {"line": 2},
            "what": "Se importa el módulo 'json' y 'datetime', que contienen herramientas para trabajar con JSON y fechas/horas.",
            ...
            "state": {"globals": {"json": "<module>", "datetime": "<module>"}}
        },
        {
            "highlight": {"line": 6},
            ...
            "state": {"globals": {"json": "<module>", "datetime": "<module>", "generar_acta_de_evidencia": "<function>"}}
        },
        {
            "highlight": {"line": 9},
        ...
        {
            "highlight": {"line": 10},
            "what": "Se llama a la función que importamos de nuestro propio módulo para generar el acta.",
