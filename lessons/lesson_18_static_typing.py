    ...
    "steps": [
        {
            ...
            "state": {"globals": {"ActaEvidencia": "<pydantic.BaseModel>"}}
        },
        {
            "highlight": {"line": 14},
            ...
            "state": {
                "globals": {
                    "ActaEvidencia": "<pydantic.BaseModel>",
                    "acta_valida": "<ActaEvidencia object>"
                }
            }
        },
        {
            ...
            "state": {"globals": {"datos_invalidos": "{'id_expediente': '...', 'cuantia_reclamada': -500}"}}
        },
        {
            "highlight": {"line": 20},
            ...
            "state": {
                "globals": {"datos_invalidos": "{...}"},
                "io": {"out": ["2 validation errors for ActaEvidencia\ncuantia_reclamada\n  Input should be a positive float [type=positive_float, ...]\ncustodio\n  Field required [type=missing, ...]"]}
            }
        }
    ]
}
